<!-- Page Heading -->
<h1 class="h3 mb-3 text-gray-800">Tambah Data Pembelian</h1>
        ...
        <div class="card-body">
            <form action="" method="post" autocomplete="off">
                <div class="form-group">
                    ...
                    <input type="date" name="pembelian_tanggal" id="pembelian_tanggal" class="form-control <?= form_error('pembelian_tanggal') ? 'is-invalid' : null; ?>" placeholder="Isi nama" value="<?= set_value('pembelian_tanggal'); ?>">
                ...
                <div class="form-group">
                    ...
                    <select name="pengajuan_id" id="pengajuan_id" class="form-control <?= form_error('pengajuan_id') ? 'is-invalid' : null; ?>">
                        ...
                        <option value="<?= $p['pengajuan_id']; ?>" <?= set_value('pengajuan_id') == $p['pengajuan_id'] ? 'selected' : null; ?>><?= date('d F Y', strtotime($p['pengajuan_tanggal'])); ?> - <?= $nomor_pengajuan; ?> - <?= $p['user_nama']; ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="aset_id" id="aset_id" class="form-control <?= form_error('aset_id') ? 'is-invalid' : null; ?>">
                        ...
                        <option value="<?= $a['aset_id']; ?>" <?= set_value('aset_id') == $a['aset_id'] ? 'selected' : null; ?>><?= ucwords($a['kelompok_nama']); ?> - <?= $a['aset_nama']; ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="pembelian_harga" id="pembelian_harga" class="form-control <?= form_error('pembelian_harga') ? 'is-invalid' : null; ?>" min="0" oninput="validity.valid || (value=null)" placeholder="Harga barang" value="<?= set_value('pembelian_harga'); ?>">
