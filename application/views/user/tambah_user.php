<!-- Page Heading -->
<h1 class="h3 mb-3 text-gray-800">Tambah Data User</h1>
        ...
        <div class="card-body">
            <form action="" method="post" autocomplete="off">
                <div class="form-group">
                    ...
                    <input type="text" name="user_username" id="user_username" class="form-control <?= form_error('user_username') ? 'is-invalid' : null; ?>" placeholder="Isi username" value="<?= set_value('user_username'); ?>">
                    <?= form_error('user_username') ? form_error('user_username') : null; ?>
                </div>
                <div class="form-group">
                    <label for="user_nama">Nama <span class="text-danger">*</span></label>
                    <input type="text" name="user_nama" id="user_nama" class="form-control <?= form_error('user_nama') ? 'is-invalid' : null; ?>" placeholder="Isi nama" value="<?= set_value('user_nama'); ?>">
                    <?= form_error('user_nama') ? form_error('user_nama') : null; ?>
                </div>
                <div class="form-group">
                    <label for="user_telepon">Telepon</label>
                    <input type="number" name="user_telepon" id="user_telepon" class="form-control" placeholder="Isi telepon" value="<?= set_value('user_telepon'); ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="user_password_konfirmasi">Password Konfirmasi <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="user_role" id="administrator" value="administrator" required <?= set_value('user_role') == 'administrator' ? 'checked' : null; ?>>
                        <label class="form-check-label" for="administrator">Administrator</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="user_role" id="direksi" value="direksi" <?= set_value('user_role') == 'direksi' ? 'checked' : null; ?>>
                        <label class="form-check-label" for="direksi">Direksi</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="user_role" id="karyawan" value="karyawan" <?= set_value('user_role') == 'karyawan' ? 'checked' : null; ?>>
